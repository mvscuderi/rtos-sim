...
Your correct-output.txt should contain a time trace for your simulation as explained below. 
...
Note, if the context switching overhead is zero, there is no need to print it in the correct-output.txt file.
Please  refer to the individual test subdirectories in this project template for more examples.  
